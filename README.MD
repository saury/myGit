...
### 把本地库内容推送至远程库，第一行为首次推送添加-u以关联master分支，第二行为首次以后的简化
...
### 不用fast forward方式合并分支，即可在分支log中显示
...
### 如果git pull提示“no tracking information”，则说明本地分支和远程分支的链接关系没有创建，需要用命令创建
